...
savefig(p, "Figures/Figure5a.pdf")
...
#plot!(p, df.M, df.Cournot_inferred_C_pct)
plot!(p, xlabel = "Number of third markets (M)", ylabel = "% of correct inferred conduct", legend=:bottomright, xticks = [50, 100, 200, 500, 800, 1000])
savefig(p, "Figures/Figure5b.pdf")
...
savefig(p, "Figures/Figure6a.pdf")
...
savefig(p, "Figures/Figure6b.pdf")
...
savefig(p, "Figures/Figure7a.pdf")
...
savefig(p, "Figures/Figure7b.pdf")
