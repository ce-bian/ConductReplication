...
directory = readdir("Data/Out/CES_MC/main_est/policy_table_ad_valorem/generalized_varyM")
strings_to_test = ["C3", "N1", "Muomega01.5", "Vomega00.1", "Muxi0-3.0", "Vpsi2.0", "retry"]
...
for file in WdfB_WdfC_hausman_files
    ...
    W_dfB, W_dfC = load("Data/Out/CES_MC/main_est/policy_table_ad_valorem/generalized_varyM/$file", "W_dfB", "W_dfC")
...
# # output
texout_new(B_policy_table_reduced_sub, "Tables/CES_MC/main_est_varyCN/policy_table_ad_valorem/B_policy_table_separate_draw_C3N1_varyM_inferred_true_reduced_case1_modified.tex")
texout_new(C_policy_table_reduced_sub, "Tables/CES_MC/main_est_varyCN/policy_table_ad_valorem/C_policy_table_separate_draw_C3N1_varyM_inferred_true_reduced_case1_modified.tex")
...
savefig(p, "Figures/CES_MC/policy_analysis_ad_valorem/extended_3rd_mkt/varyM/Bertrand_inferred_B_pct_vs_M_C3N1_varyM2_case1_modified.pdf")
...
#plot!(p, df.M, df.Cournot_inferred_C_pct)
plot!(p, xlabel = "Number of third markets", ylabel = "% of correct inferred conduct", legend=:bottomright, xticks = [50, 100, 200, 500, 800, 1000])
savefig(p, "Figures/CES_MC/policy_analysis_ad_valorem/extended_3rd_mkt/varyM/Cournot_inferred_C_pct_vs_M_C3N1_varyM2_case1_modified.pdf")
...
savefig(p, "Figures/CES_MC/policy_analysis_ad_valorem/extended_3rd_mkt/varyM/Bertrand_avg_delta_W_pct_vs_M_C3N1_varyM_case1_modified.pdf")
...
plot!(p, xlabel = "Number of third markets", ylabel = L"avg $\frac{W-W_0}{W_0} \% $ ", legend=:bottomright, xticks = [50, 100, 200, 500, 800, 1000])
savefig(p, "Figures/CES_MC/policy_analysis_ad_valorem/extended_3rd_mkt/varyM/Cournot_avg_delta_W_pct_vs_M_C3N1_varyM_case1_modified.pdf")
...
# savefig(p, "Figures/CES_MC/policy_analysis/extended_3rd_mkt/varyM/Bertrand_min_delta_W_pct_vs_M_C2N1_varyM_full2_filter_extremes_parameter3.pdf")
...
# #plot!(p, df.M, df.Bertrand_min_W_pct*100, linewidth = 2, label = "optimal value based on full sample")
# plot!(p, xlabel = "Number of third markets", ylabel = L"min $\frac{W-W_0}{W_0} \% $", legend=:bottomright, xticks = [50, 100, 200, 500, 800, 1000])
# savefig(p, "Figures/CES_MC/policy_analysis/extended_3rd_mkt/varyM/Cournot_min_delta_W_pct_vs_M_C2N1_varyM_full2_filter_extremes_parameter3.pdf")
# # BAD